...
class VibratorVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        SDKUserDefaults.setValue(false, forKey: SDK_VibratorCompleteKey)
    ...
    func setUIElementsProperties() {
        ...
        self.testImgView.image = #imageLiteral(resourceName: "vibration")
        ...
        if sender.titleLabel?.text == self.getLocalizatioStringValue(key: "Start").uppercased() {
            ...
            if self.numberTxtField.text == String(num1) {
                ...
                if SDKResultString.contains("CISS13;") {
                    SDKResultString = SDKResultString.replacingOccurrences(of: "CISS13;", with: "")
                }
    ...
    func goNext() {
        ...
        SDKUserDefaults.setValue(true, forKey: SDK_VibratorCompleteKey)
