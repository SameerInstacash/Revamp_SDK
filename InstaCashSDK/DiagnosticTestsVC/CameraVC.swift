...
class CameraVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        SDKUserDefaults.setValue(false, forKey: SDK_CameraCompleteKey)
    ...
    func setUIElementsProperties() {
        ...
        self.testImgView.image = #imageLiteral(resourceName: "camera")
        ...
        self.info1Lbl.font = UIFont.init(name: SDKFontRegular, size: self.info1Lbl.font.pointSize)
        self.info2Lbl.text = self.getLocalizatioStringValue(key: "2. Press capture to take a shot!")
        self.info2Lbl.font = UIFont.init(name: SDKFontRegular, size: self.info2Lbl.font.pointSize)
    ...
    @IBAction func startButtonPressed(_ sender: UIButton) {
        ...
        camera.didCancel = {
            ...
            SDKUserDefaults.setValue(false, forKey: SDK_CameraTestKey)
            SDKUserDefaults.setValue(false, forKey: "Autofocus")
        ...
        camera.didFinishCapturingImage = { (image: UIImage?, metadata: [AnyHashable : Any]?) in
            ...
            if self.isFrontClick == true && self.isBackClick == true {
                ...
                SDKUserDefaults.setValue(true, forKey: SDK_CameraTestKey)
                SDKResultJSON[SDK_CameraTestKey].int = 1
                
                SDKUserDefaults.setValue(true, forKey: "Autofocus")
                SDKResultJSON["Autofocus"].int = 1
                
                if SDKResultString.contains("CISS01;") {
                    SDKResultString = SDKResultString.replacingOccurrences(of: "CISS01;", with: "")
                }
                
                SDKUserDefaults.setValue(true, forKey: SDK_CameraCompleteKey)
    ...
    @IBAction func skipButtonPressed(_ sender: UIButton) {
        ...
        let buttonOne = CancelButton(title: self.getLocalizatioStringValue(key:"Tes")) {
            DispatchQueue.main.async() {
                ...
                if !SDKResultString.contains("CISS01;") {
                    SDKResultString = SDKResultString + "CISS01;"
                }
