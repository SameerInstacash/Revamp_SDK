...
class EarphoneVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        SDKUserDefaults.setValue(false, forKey: SDK_EarphoneCompleteKey)
    ...
    func setUIElementsProperties() {
        ...
        self.testImgView.image = #imageLiteral(resourceName: "earphone")
    ...
    @objc func audioRouteChangeListener(notification:NSNotification) {
        ...
        DispatchQueue.main.async {
            ...
            case AVAudioSession.RouteChangeReason.newDeviceAvailable.rawValue:
                ...
                SDKUserDefaults.setValue(true, forKey: SDK_EarphoneTestKey)
                SDKResultJSON[SDK_EarphoneTestKey].int = 1
                
                if SDKResultString.contains("CISS11;") {
                    SDKResultString = SDKResultString.replacingOccurrences(of: "CISS11;", with: "")
                }
                
                SDKUserDefaults.setValue(true, forKey: SDK_EarphoneCompleteKey)
    ...
    @IBAction func skipButtonPressed(_ sender: UIButton) {
        ...
        let buttonOne = CancelButton(title: self.getLocalizatioStringValue(key:"Yes")) {
            ...
            SDKUserDefaults.setValue(false, forKey: SDK_EarphoneTestKey)
            SDKResultJSON[SDK_EarphoneTestKey].int = -1
             
            if !SDKResultString.contains("CISS11;") {
                SDKResultString = SDKResultString + "CISS11;"
            }
