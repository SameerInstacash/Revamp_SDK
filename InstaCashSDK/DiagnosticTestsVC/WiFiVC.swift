...
class WiFiVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        SDKUserDefaults.setValue(false, forKey: SDK_WifiCompleteKey)
    ...
    func setUIElementsProperties() {
        ...
        self.testImgView.image = #imageLiteral(resourceName: "wifi")
    ...
    @objc func runTimedCode() {
        ...
        if Luminous.Network.isConnectedViaWiFi {
            ...
            SDKUserDefaults.setValue(true, forKey: SDK_WifiTestKey)
            SDKResultJSON[SDK_WifiTestKey].int = 1
            
            if SDKResultString.contains("CISS04;") {
                SDKResultString = SDKResultString.replacingOccurrences(of: "CISS04;", with: "")
            }
            
        }else {
            
            SDKUserDefaults.setValue(false, forKey: SDK_WifiTestKey)
            SDKResultJSON[SDK_WifiTestKey].int = 0
        ...
        if count > 3 {
            DispatchQueue.main.async {
                ...
                SDKUserDefaults.setValue(true, forKey: SDK_WifiCompleteKey)
