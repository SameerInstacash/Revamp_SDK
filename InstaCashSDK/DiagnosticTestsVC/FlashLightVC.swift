...
class FlashLightVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        SDKUserDefaults.setValue(false, forKey: SDK_TorchCompleteKey)
    ...
    @IBAction func startButtonPressed(_ sender: UIButton) {
        ...
        if sender.titleLabel?.text == self.getLocalizatioStringValue(key: "Start").uppercased()  {
            ...
            if self.numberTxtField.text == String(num1) {
                ...
                SDKResultJSON[SDK_TorchTestKey].int = 1
                SDKUserDefaults.setValue(true, forKey: SDK_TorchTestKey)
                
                if SDKResultString.contains("CISS16;") {
                    SDKResultString = SDKResultString.replacingOccurrences(of: "CISS16;", with: "")
                }
                
                self.goNext()
            }else {

                SDKResultJSON[SDK_TorchTestKey].int = 0
                SDKUserDefaults.setValue(false, forKey: SDK_TorchTestKey)
                 
                if !SDKResultString.contains("CISS16;") {
                    SDKResultString = SDKResultString + "CISS16;"
                }
    ...
    func goNext() {
        ...
        SDKUserDefaults.setValue(true, forKey: SDK_TorchCompleteKey)
